...
parser.add_argument('--trained_model',
                    default='weights/VOCssd300v5.pth', type=str,
...
def test_net(save_folder, net, cuda, dataset, transform, top_k,
    ...
    output_dir = get_output_dir('ssd300_eval', set_type)
    ...
    for key in state_dict.keys():
        if 'module' in key:
            ...
            if pre[0] == 'module':
                ...
                state_dict_copy[k] = state_dict[key]

    net.load_state_dict(state_dict_copy)
    net.eval()
